class NewsfeedsController < ApplicationController
  ...
  # GET /newsfeeds/new
  def new
    @newsfeed = @dashboard.newsfeeds.new
  end
  ...
  # POST /newsfeeds.json
  def create
    @newsfeed = @dashboard.newsfeeds.new(newsfeed_params)
  ...
  private
    ...
    def newsfeed_params
      params.require(:newsfeed).permit(:title, :body, :dashboard_id)
    end
end
