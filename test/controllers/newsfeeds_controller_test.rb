...
class NewsfeedsControllerTest < ActionController::TestCase
  ...
  test "should create newsfeed" do
    assert_difference('Newsfeed.count') do
      post :create, newsfeed: { body: @newsfeed.body, dashboard_id: @newsfeed.dashboard_id, title: @newsfeed.title }
    end
  ...
  test "should update newsfeed" do
    patch :update, id: @newsfeed, newsfeed: { body: @newsfeed.body, dashboard_id: @newsfeed.dashboard_id, title: @newsfeed.title }
    assert_redirected_to newsfeed_path(assigns(:newsfeed))
  end
